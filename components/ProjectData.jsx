...
const PROJECTS = {
  ...
  soundar: {
    title: 'soundAr',
    tagline: 'Local voice generation and model benchmarking',
    description: 'An open-source Linux desktop studio for generating, cloning, comparing, and benchmarking voices with local speech models.',
    status: 'Shipped',
    platform: 'Linux',
    year: '2026',
    category: 'shipped',
